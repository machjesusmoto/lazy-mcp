 ...
 */
export declare function validateMcpJsonConfig(config: McpJsonConfig): void;
/**
 * Validates an MCPServerConfig object.
 * @throws Error if validation fails
 */
export declare function validateMCPServerConfig(config: MCPServerConfig): void;
/**
 * Validates a BlockedMCPServerConfig object.
 * @throws Error if validation fails
 */
export declare function validateBlockedMCPServerConfig(config: BlockedMCPServerConfig): void;
/**
 ...
 *                                                              ↘ error
 */
export type MigrationState = 'idle' | 'validating' | 'conflict_resolution' | 'ready' | 'executing' | 'complete' | 'error';
/**
 ...
 */
export declare function validateMigrationOperation(operation: MigrationOperation): {
    valid: boolean;
    errors: string[];
};
/**
